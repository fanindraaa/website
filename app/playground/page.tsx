  ...
  return (
    <>
      <header className="col-span-full md:col-span-12 lg:col-span-5 lg:sticky lg:top-8 lg:self-start mb-20 lg:mb-0">
        ...
        <p className="mt-0">
          Besides my main projects, I explore different areas of interest in my
          free time. This is the best way to discover useful solutions, train my
          eyes for details, and develop more specific insights in certain
          topics.
        </p>
      </header>
